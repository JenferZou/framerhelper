<template>
  <div class="container">
    <div style="width: 400px; padding: 30px; background-color: white; border-radius: 5px; opacity: 0.9">
      <div style="text-align: center; font-size: 20px; margin-bottom: 20px; color: #11549a; font-weight: bold">欢迎注册</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item>
          <el-button style="width: 100%; background-color: #11549a; border-color: #28826b; color: white; font-weight: bold" @click="register">注 册</el-button>
        </el-form-item>
