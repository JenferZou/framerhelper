...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'goods', name: 'Goods', meta: { name: '扶贫商品' }, component: () => import('../views/manager/Goods') },
      { path: 'orders', name: 'Orders', meta: { name: '订单信息' }, component: () => import('../views/manager/Orders') },
      { path: 'poorApply', name: 'PoorApply', meta: { name: '贫困户申请' }, component: () => import('../views/manager/PoorApply') },
      { path: 'projectApply', name: 'ProjectApply', meta: { name: '扶贫项目申请' }, component: () => import('../views/manager/ProjectApply') },
      { path: 'comment', name: 'Comment', meta: { name: '政策评论' }, component: () => import('../views/manager/Comment') },
    ]
  },
  {
    path: '/front',
    ...
    children: [
      ...
      { path: 'agritainmentDetail', name: 'AgritainmentDetail', meta: { name: '农家乐详情' }, component: () => import('../views/front/AgritainmentDetail') },
      ...
      { path: 'praise', name: 'Praise', meta: { name: '历史点赞' }, component: () => import('../views/front/Praise') },
    ]
  },
